...
30463 rows, 15 columns
found using "read_csv(here("data","surveys.csv"))"
...
7 characters, 7 floats, 1 date 
found using "spec(surveys)"
<!-- You can either write code here or in the code chunk for #1, but I **must** see the code you used to address this question!  -->
...
ggplot(data = surveys,
      mapping = aes(x=weight, y= hindfoot_length)) +
        ...
        labs(title = "Hindfood Length vs weight",
            subtitle = "Creature Hindfoot Length in Milimeters",
             x = "Creature Weight in Grams",
             y = "")
